...
public class EmployeeAction extends ActionBase {
    ...
    public void create() throws ServletException, IOException {
        ...
        if (checkToken()) {
            ...
            //System.out.println("君の名前は" + name);
/*
            try {
                byte[] byteData = name.getBytes("UTF-8");
...
*/
            ...
            if (errors.size() > 0) {
                //System.out.println("【EmployeeAction】create error");
                //登録中にエラーがあった場合
                ...
                //System.out.println("【EmployeeAction】create done");
                //登録中にエラーがなかった場合
